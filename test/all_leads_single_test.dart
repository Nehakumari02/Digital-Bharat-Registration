...
void main() {
  testWidgets('AllLeadsScreen with data', (WidgetTester tester) async {
    FlutterError.onError = (FlutterErrorDetails details) {
      print(details.exception);
      throw details.exception;
    };
    
    // We cannot mock LeadController easily, so let's just extract the body
    final leads = [
      LeadModel(
        id: 1,
        name: 'Test Farmer',
      ...
      MaterialApp(
        home: Scaffold(
          body: SingleChildScrollView(
            // Responsive.horizontalPadding returns 20 on small screens
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: leads.map((lead) {
                    return InkWell(
                      onTap: () {},
                      // Re-implement a simple version of _leadItem or just Card
                      child: Card(
                        elevation: 2,
